...
/* ============================================================
   ...
   ============================================================ */
const API = {
    salvar:      '../actions/salvarAluno.act.php',
    editar:      '../actions/editarAluno.act.php',
    excluir:     '../actions/excluirAluno.act.php',
    transferir:  '../actions/transferirAluno.act.php',
...
function abrirModoVisualizar(dataset) {
    ...
    campoId.value       = dataset.id_aluno;
