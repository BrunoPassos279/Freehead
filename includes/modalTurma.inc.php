...
<div class="modal" id="modalTurma">
    ...
    <div class="modal-header">
        ...
        <button type="button" class="modal-fechar" id="modalFechar" aria-label="Fechar">
    ...
    <div class="modal-body">
        <form id="formTurma" class="form-modal" autocomplete="off">
            ...
            <div class="form-linha">
                <div class="form-grupo">
                    ...
                    <input type="text" id="campoNomeTurma" name="nome_turma" placeholder="Ex: Inglês Básico - Manhã">
                </div>
            </div>
            ...
            <!-- Idioma depende do professor -->
            <div class="form-linha">
                <div class="form-grupo">
                    <label for="campoIdioma">Idioma</label>
                    <select id="campoIdioma" name="id_idioma" disabled>
                ...
                <div class="form-grupo">
                    ...
                    <select id="campoNivel" name="id_nivel" disabled>
                        <option value="">Escolha um idioma primeiro</option>
                    </select>
                </div>
            </div>
        ...
        <div class="mensagem-validacao" id="mensagemValidacaoTurma"></div>
    </div>

    <!-- Rodapé -->
    <div class="modal-footer">

        <button type="button" class="btn-modal btn-salvar" id="btnSalvar">
            Salvar turma
        </button>

        <div class="acoes-edicao" id="acoesEdicao" style="display:none;">

            <button type="button" class="btn-modal btn-editar" id="btnEditar">
            ...
            <button type="button" class="btn-modal btn-excluir" id="btnExcluir">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round">
            ...
            <button type="button" class="btn-modal btn-acao" id="btnIncluirAluno">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round">
        ...
        <button type="button" class="btn-modal btn-salvar" id="btnSalvarEdicao" style="display:none;">
            Salvar alterações
        </button>
    ...
    <div class="painel-interno painel-exclusao" id="painelExclusao">
        ...
        <p class="exclusao-titulo">
            Tem certeza que deseja excluir a turma<br>
            <strong id="nomeExclusao"></strong>?
        </p>

        <p class="exclusao-aviso">Essa ação não pode ser desfeita.</p>

        <div class="painel-btns">
            <button type="button" class="btn-modal btn-cancelar" id="btnCancelarExclusao">
                Cancelar
            </button>

            <button type="button" class="btn-modal btn-excluir" id="btnConfirmarExclusao">
                Sim, excluir
            </button>
        </div>
    </div>
    ...
    <div class="painel-interno painel-selecao" id="painelAluno">
        ...
        <div class="form-linha">
            <div class="form-grupo">
                <label for="campoValorMensalidade">Valor da mensalidade</label>
                <input 
                    type="number" 
                    id="campoValorMensalidade" 
                    min="0" 
                    step="0.01" 
            ...
            <div class="form-grupo">
                <label for="campoDiaVencimento">Dia de vencimento</label>
                <input 
                    type="number" 
                    id="campoDiaVencimento" 
                    min="1" 
                    max="31" 
                    value="10"
                >
...
<div class="mensagem-validacao" id="mensagemValidacaoMatricula"></div>

        <div class="painel-btns">
            <button type="button" class="btn-modal btn-cancelar" id="btnCancelarAluno">
                Cancelar
            </button>

            <button type="button" class="btn-modal btn-salvar" id="btnConfirmarAluno">
                Confirmar matrícula
            </button>
        </div>
    </div>
