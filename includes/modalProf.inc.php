    ...
    <div class="modal-body">
        <form id="formProf" class="form-modal" autocomplete="off">
           ...
           <div class="checkboxes-grupo" id="checkboxIdiomas">
                ...
                <?php if (!empty($idiomasPermitidosProfessor)): ?>

                    <?php foreach ($idiomasPermitidosProfessor as $idioma): ?>
                        <label>
                            <input 
                                type="checkbox" 
                                name="idiomas[]" 
                                value="<?php echo htmlspecialchars($idioma['id_idioma']); ?>" 
                                id="cb<?php echo htmlspecialchars($idioma['id_idioma']); ?>"
                            >
                ...
                <?php else: ?>
                    ...
                    <p class="texto-config">
                        Nenhum idioma configurado para esta escola.
                    </p>
