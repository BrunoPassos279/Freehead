...
/* ============================================================
   ...
   ============================================================ */
const API = {
    salvar:      '../actions/salvarProfessor.php',
    editar:      '../actions/editarProfessor.php',
    excluir:     '../actions/excluirProfessor.php',
    associar:    '../actions/associarProfessorTurma.php',
    listarTurmas:'../data/freehead_mock.json'
};
